...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissioinList(@ExistStore @PathVariable(name = "storeId") Long storeId,@ExistPage @RequestParam(name = "page") Integer page){
